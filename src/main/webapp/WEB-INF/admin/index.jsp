...
<div class="header"><!-- 头部 -->
    ...
    <div class="container"><!-- 此处包含左侧菜单和iframe标签的内容 -->
          ...
          <ul class="nav" id="main-menu">
              ...
              <li><!-- 第三个父目录 -->
                  <a><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;&nbsp;菜品管理</a>
                    <ul class="nav nav-second-level" >
                      ...
                      <li>
                          <a href="${rootPath}manage/MenuManager" target="mainFrame"><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;&nbsp;管理菜品</a>
                      </li>
                  </ul> 
              </li>
              <li><!-- 第四个父目录 -->
              ...
              <li> <!-- 第六个父目录 -->
                <a><span class="glyphicon glyphicon-folder-open"></span>&nbsp;&nbsp;&nbsp;个人中心</a>
                 <ul class="nav nav-second-level">
                    <li>
                        <a href="${rootPath}manage/Change_getMyself" target="mainFrame"><span class="glyphicon glyphicon-phone"></span>&nbsp;&nbsp;&nbsp;查看个人资料</a>
                    </li>
                    <li>
        ...
        <iframe src=""   id="ifr" name="mainFrame"></iframe>
