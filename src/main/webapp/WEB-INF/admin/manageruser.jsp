...
<body  style="background: url(${rootPath}images/iframebg.jpg);"  >
	...
	<div style="margin-left:60%; height:30px;margin-top:1%;">
		<div style="margin-left:-50%;font-weight: bold;">${updateUserMsg}${deleteUserMsg}</div>
		<form action="${rootPath}manage/UserManager_Inquiry" method="post">
			<input style="border-radius:7px;background-color: #F0F0F0;height:25px; width:30%;" type="text" name="inquiry" placeholder="手机号/姓名/身份" required="required">
