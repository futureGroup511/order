...
<body   style="background: url(${rootPath}/images/m-91.jpg);">
		...
		<div class="addingredient">
			<form action="Ingredient_addIngredient" method="post">
				<lable id="text"><span style="padding-right:45%">名</span>称：</lable>
				...
				<lable id="text"><span style="padding-right:45%">类</span>型：</lable>
				<select name="ingredient.type">
					<option value="原料">原料</option>
					<option value="配料">配料</option>
				</select><br>
				<lable id="text"><span style="padding-right:45%">简</span>介：</lable>
