...
<head>
    <meta charset="UTF-8">
    <title>查看所有订单</title>
    <link rel="stylesheet" type="text/css" href="../css/bootstrapwqj.css">
    <style>
        .aa{
            width: 90%;
            height: 400px;
       ...
       <c:forEach items="${allOrder}" var="item"> 
	            <tr>  
	                ...
	                <td>${item.remark}</td>
	                 ...
	                 <c:if test="${item.status eq '未付款'}"><a href="${rootPath}cook/orderCenter_DoOrder?OrderId=${item.id}">处理订单</a></c:if>
