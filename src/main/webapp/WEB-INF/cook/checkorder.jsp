         ...
         <c:forEach items="${inform}" var="item"> 
	            <tr>  
	                ...
	                <td>${item.tableName}</td>
	                 <td style="width:400px;height:20px"><textarea readonly="readonly" style="width:400px;height:30px;resize:none;">${item.content}</textarea></td>
	            </tr>  
        	</c:forEach>
        </tbody>
    </table>
			...
			<tbody>
				...
				<c:forEach items="${paCut.data}" var="item">
					<tr>
						...
						<td>${item.cookName}</td>
						<td style="width:200px;height:10px"><textarea readonly="readonly" style="width:200px;height:30px;resize:none;">${item.remark}</textarea></td>
